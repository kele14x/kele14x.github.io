...
date: '2016-12-10'
permalink: "/debug-bram-using-axi-bram-controller/"
---
...
![Block Design](/assets/images/posts/debug-bram-using-axi-bram-controller/axi-bram-block-design.png)
...
![Address Editor](/assets/images/posts/debug-bram-using-axi-bram-controller/axi-bram-address-editor.png)

这里有个非常纠结的地方，我们看到在地址编辑器里，设定地址范围大小是 8k。这对应地址范围 0xC000\_0000 ~ 0xC000\_1FFF，即 13 位地址线。

![AXI BRAM Controller](/assets/images/posts/debug-bram-using-axi-bram-controller/axi-bram-controller.png)
