...
![](/assets/images/posts/xilinx-zynq-vip/xilinx-zynq-vip-0.png "Block Design - design_1")
...
1. 运行 **test** 这个空仿真，以便确认 VIP 的 Hierarchy 路径。找到 **/test/DUT/design_1_i/processing_system7_0/inst**，这就是 Zynq VIP 的路径
   ...
   ![Simulation - test](/assets/images/posts/xilinx-zynq-vip/xilinx-zynq-vip-1.png)
